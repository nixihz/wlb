...
type Data struct {
	...
	Lark     *Data_Lark     `protobuf:"bytes,3,opt,name=lark,proto3" json:"lark,omitempty"`
}
...
type Data_Lark struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	FeishuAppName              string `protobuf:"bytes,1,opt,name=feishu_app_name,json=feishuAppName,proto3" json:"feishu_app_name,omitempty"`
	FeishuAppId                string `protobuf:"bytes,2,opt,name=feishu_app_id,json=feishuAppId,proto3" json:"feishu_app_id,omitempty"`
	FeishuAppSecret            string `protobuf:"bytes,3,opt,name=feishu_app_secret,json=feishuAppSecret,proto3" json:"feishu_app_secret,omitempty"`
	FeishuAppVerificationToken string `protobuf:"bytes,4,opt,name=feishu_app_verification_token,json=feishuAppVerificationToken,proto3" json:"feishu_app_verification_token,omitempty"`
	FeishuAppEventEncryptKey   string `protobuf:"bytes,5,opt,name=feishu_app_event_encrypt_key,json=feishuAppEventEncryptKey,proto3" json:"feishu_app_event_encrypt_key,omitempty"`
}

func (x *Data_Lark) Reset() {
	*x = Data_Lark{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_Lark) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Lark) ProtoMessage() {}

func (x *Data_Lark) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Lark.ProtoReflect.Descriptor instead.
func (*Data_Lark) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Lark) GetFeishuAppName() string {
	if x != nil {
		return x.FeishuAppName
	}
	return ""
}

func (x *Data_Lark) GetFeishuAppId() string {
	if x != nil {
		return x.FeishuAppId
	}
	return ""
}

func (x *Data_Lark) GetFeishuAppSecret() string {
	if x != nil {
		return x.FeishuAppSecret
	}
	return ""
}

func (x *Data_Lark) GetFeishuAppVerificationToken() string {
	if x != nil {
		return x.FeishuAppVerificationToken
	}
	return ""
}

func (x *Data_Lark) GetFeishuAppEventEncryptKey() string {
	if x != nil {
		return x.FeishuAppEventEncryptKey
	}
	return ""
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x8c, 0x05, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	0x72, 0x65, 0x64, 0x69, 0x73, 0x12, 0x29, 0x0a, 0x04, 0x6c, 0x61, 0x72, 0x6b, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x4c, 0x61, 0x72, 0x6b, 0x52, 0x04, 0x6c, 0x61, 0x72, 0x6b,
	...
	,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Lark)(nil),           // 7: kratos.api.Data.Lark
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.lark:type_name -> kratos.api.Data.Lark
